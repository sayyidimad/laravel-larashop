...
class CategoryController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('categories.edit', [$id])->with('status', 'Category updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('categories.index')->with('status', 'Category moved to trash successfully');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('categories.index')->with('status', 'Category restored successfully ');
    }
