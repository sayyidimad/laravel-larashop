...
class BookController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->get('save_action') == 'PUBLISH') {
            return redirect()->route('books.create')->with('status', 'Book saved and published successfully');
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('books.edit', [$book->id])->with('status', 'Book updated successfully');
    }
